"""Second-order Strang solver for the boundary-damped XY chain.

The generator is split into the Hamiltonian system generator and one
dissipative generator for each boundary jump operator. The full system
step is placed in the middle, surrounded symmetrically by jump half-steps.
"""
...
def main():
    ...
    # The generator decomposition is the same for Lie and Strang
    # formulas; only the order and duration of the factors differ.
    (
        system_liouvillian,
        jump_liouvillians,
    ...
    density_matrices = classical.strang_trotter_evolve(
        rho0,
        system_liouvillian,
        jump_liouvillians,
        times,
    ...
    plot_observables(
        ...
        output_path=(
            f"Model1/figures/obs_strang_trotter_{N_QUBITS}.png"
        ),
    )
